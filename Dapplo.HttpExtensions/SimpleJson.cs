				...
				if (objects != null)
				{
					...
					else
					{
						...
						else
						{
							...
							// TODO: Remove the found keys, to add them as extension data?
							...
							// Check if there is any unprocessed data, if so check if there is a ExtensionDataAttribute inside the target object
