...
namespace Dapplo.HttpExtensions.Extensions
{
	...
	public static class HttpBehaviourExtensions
	{
		...
		public static THttpRequestConfiguration GetConfig<THttpRequestConfiguration>(this IHttpBehaviour httpBehaviour) where THttpRequestConfiguration : class, IHttpRequestConfiguration, new()
		{
