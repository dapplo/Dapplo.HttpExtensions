...
namespace Dapplo.HttpExtensions.OAuth
{
	...
	public class OAuth1HttpBehaviour : IChangeableHttpBehaviour
	{
		...
		/// </summary>
		public Action<HttpRequestMessage> BeforeSend
		{
			get;
			set;
		}
		...
		/// </summary>
		public Action<IDictionary<string, string>> OnAccessTokenValues
		{
			get;
			set;
		}
		...
		public Encoding DefaultEncoding
		{
			get
			{
				return _wrapped.DefaultEncoding;
			}
			set
			{
				_wrapped.DefaultEncoding = value;
			}
		}
		...
		public Action<float> DownloadProgress
		{
			get
			{
				return _wrapped.DownloadProgress;
			}
			set
			{
				_wrapped.DownloadProgress = value;
			}
		}
		...
		public HttpCompletionOption HttpCompletionOption
		{
			get
			{
				return _wrapped.HttpCompletionOption;
			}
			set
			{
				_wrapped.HttpCompletionOption = value;
			}
		}
		...
		public IList<IHttpContentConverter> HttpContentConverters
		{
			get
			{
				return _wrapped.HttpContentConverters;
			}
			set
			{
				_wrapped.HttpContentConverters = value;
			}
		}
		...
		public IHttpSettings HttpSettings
		{
			get
			{
				return _wrapped.HttpSettings;
			}
			set
			{
				_wrapped.HttpSettings = value;
			}
		}
		...
		public IJsonSerializer JsonSerializer
		{
			get
			{
				return _wrapped.JsonSerializer;
			}
			set
			{
				_wrapped.JsonSerializer = value;
			}
		}
		...
		public Action<HttpClient> OnHttpClientCreated
		{
			get
			{
				return _wrapped.OnHttpClientCreated;
			}
			set
			{
				_wrapped.OnHttpClientCreated = value;
			}
		}
		...
		public Func<HttpContent, HttpContent> OnHttpContentCreated
		{
			get
			{
				return _wrapped.OnHttpContentCreated;
			}
			set
			{
				_wrapped.OnHttpContentCreated = value;
			}
		}
		...
		public Func<HttpMessageHandler, HttpMessageHandler> OnHttpMessageHandlerCreated
		{
			get
			{
				return _wrapped.OnHttpMessageHandlerCreated;
			}
			set
			{
				_wrapped.OnHttpMessageHandlerCreated = value;
			}
		}
		...
		public Func<HttpRequestMessage, HttpRequestMessage> OnHttpRequestMessageCreated
		{
			get
			{
				return _wrapped.OnHttpRequestMessageCreated;
			}
			set
			{
				_wrapped.OnHttpRequestMessageCreated = value;
			}
		}
		...
		public int ReadBufferSize
		{
			get
			{
				return _wrapped.ReadBufferSize;
			}
			set
			{
				_wrapped.ReadBufferSize = value;
			}
		}
		...
		public bool ThrowOnError
		{
			get
			{
				return _wrapped.ThrowOnError;
			}
			set
			{
				_wrapped.ThrowOnError = value;
			}
		}
		...
		public Action<float> UploadProgress
		{
			get
			{
				return _wrapped.UploadProgress;
			}
			set
			{
				_wrapped.UploadProgress = value;
			}
		}
		...
		public bool UseProgressStream
		{
			get
			{
				return _wrapped.UseProgressStream;
			}
			set
			{
				_wrapped.UseProgressStream = value;
			}
		}
		...
		public bool ValidateResponseContentType
		{
			get
			{
				return _wrapped.ValidateResponseContentType;
			}
			set
			{
				_wrapped.ValidateResponseContentType = value;
			}
		}
